import{b as B,s as n,u,g as m,c as T,d as q,e as w,f as D,a as P}from"./assets/sprite-1afc6702.js";import{i as p}from"./assets/vendor-2dcf4ad5.js";const v=document.querySelector(".popular-list");async function j(){try{return await B()}catch(t){console.log(t)}}function x(t){const e=t.map(({_id:s,img:o,name:c,size:a,category:i,popularity:d})=>{const l=i.split("_").join(" ");return`<li class="popular-item" data-id='${s}'>
